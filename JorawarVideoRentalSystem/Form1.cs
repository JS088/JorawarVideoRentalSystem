...
namespace JorawarVideoRentalSystem
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            jIssueDate.Text =Current_date.ToString("dd/MM/yyyy");
            JReturnDate.Text = Current_date.ToString("dd/MM/yyyy");
        }
        ...
        public int checkRentData() {
            if (JCustomerID.Text.ToString().Equals("") && JMovieID.Text.ToString().Equals("") && jIssueDate.Text.Equals(""))
            {
                return 0;
            }
            else {
        ...
        private void JAddVideo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Check Record Once ");
            }
        }
        ...
        private void JdelVideoCD_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    // MessageBox.Show("ok "+tblData.Rows.Count);
        ...
        private void JupdateVideoCD_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Check once record ");
            }
        }
            ...
            if (checkRentData() == 1)
                {
                    ...
                    tblData1 = sqlSelect.SelectQuery("select * from JRentData where CustomerId=" + Convert.ToInt32(JCustomerID.Text.ToString()) + " and  ReturnDate = 'rent'");
        ...
        private void JReturn_Click(object sender, EventArgs e)
        {
            try
            {
                if (checkRentData() == 1)
                {
                    ...
                    sqlCmd.Parameters["@JIssue"].Value = jIssueDate.Text.ToString();
                    sqlCmd.Parameters["@JReturn"].Value = end.ToString("dd/mm/yyyy");
